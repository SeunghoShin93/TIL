...
export default {
  ...
  methods: {
    deleteTodo(todo) {
      ...
      // }
      axios
        .delete(`http://127.0.0.1:8000/api/v1/todos/${todo.id}/`, this.requestHeader)
        .then(res => {
          console.log(res)
    ...
    updateTodo(todo) {
      ...
      axios.put(`http://127.0.0.1:8000/api/v1/todos/${todo.id}/`, this.requestForm, this.requestHeader)
        .then(res => {
          console.log(res)
